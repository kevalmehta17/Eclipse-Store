  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <motion.div
        ...
        initial={{ opacity: 0, y: -20 }} // 1️⃣ Start: Hidden & Slightly upper
        animate={{ opacity: 1, y: 0 }} // 2️⃣ End: Fully Visible & Moves Up
        transition={{ duration: 0.8, delay: 0.2 }} // 3️⃣ Timing: Smooth Animation
      >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  {/*  arial-hidden:- hides an element from screen readers. */}
            ...
            >
              {loading ? (
                <>
                  <Loader
                    className="mr-2 s-5 animate-spin"
                    aria-hidden="true"
                  />
                  Loading...
                </>
